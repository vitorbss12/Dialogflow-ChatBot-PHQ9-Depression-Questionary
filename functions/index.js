  ...
  (request, response) => {
          ...
          result.map((usuarios) => {
            ...
            if (user_email === usuarios.username) {
              if (user_pass === usuarios.pass) {
                ...
                agent.add(
                  `Senha incorreta. Digite "Login" para tentar novamente ou "Criar" para criar usuário.`
                );
            }
    ...
    function depressionTest(agent) {
      ...
      if (agent.parameters["p1"].toLowerCase() == "nunca") {
        ...
        agent.parameters["p1"].toLowerCase() == "mais da metade dos dias"
      ) {
        rp1 = 2;
      } else if (
        agent.parameters["p1"].toLowerCase() == "quase todos os dias"
      ) {
        rp1 = 3;
      }
      ...
      if (agent.parameters["p2"].toLowerCase() == "nunca") {
        ...
        agent.parameters["p2"].toLowerCase() == "mais da metade dos dias"
      ) {
        rp2 = 2;
      } else if (
        agent.parameters["p2"].toLowerCase() == "quase todos os dias"
      ) {
        rp2 = 3;
      }
      ...
      if (agent.parameters["p3"].toLowerCase() == "nunca") {
        ...
        agent.parameters["p3"].toLowerCase() == "mais da metade dos dias"
      ) {
        rp3 = 2;
      } else if (
        agent.parameters["p3"].toLowerCase() == "quase todos os dias"
      ) {
        rp3 = 3;
      }
      ...
      if (agent.parameters["p4"].toLowerCase() == "nunca") {
        ...
        agent.parameters["p4"].toLowerCase() == "mais da metade dos dias"
      ) {
        rp4 = 2;
      } else if (
        agent.parameters["p4"].toLowerCase() == "quase todos os dias"
      ) {
        rp4 = 3;
      }
      ...
      if (agent.parameters["p5"].toLowerCase() == "nunca") {
        ...
        agent.parameters["p5"].toLowerCase() == "mais da metade dos dias"
      ) {
        rp5 = 2;
      } else if (
        agent.parameters["p5"].toLowerCase() == "quase todos os dias"
      ) {
        rp5 = 3;
      }
      ...
      if (agent.parameters["p6"].toLowerCase() == "nunca") {
        ...
        agent.parameters["p6"].toLowerCase() == "mais da metade dos dias"
      ) {
        rp6 = 2;
      } else if (
        agent.parameters["p6"].toLowerCase() == "quase todos os dias"
      ) {
        rp6 = 3;
      }
      ...
      if (agent.parameters["p7"].toLowerCase() == "nunca") {
        ...
        agent.parameters["p7"].toLowerCase() == "mais da metade dos dias"
      ) {
        rp7 = 2;
      } else if (
        agent.parameters["p7"].toLowerCase() == "quase todos os dias"
      ) {
        rp7 = 3;
      }
      ...
      if (agent.parameters["p8"].toLowerCase() == "nunca") {
        ...
        agent.parameters["p8"].toLowerCase() == "mais da metade dos dias"
      ) {
        rp8 = 2;
      } else if (
        agent.parameters["p8"].toLowerCase() == "quase todos os dias"
      ) {
        rp8 = 3;
      }
      ...
      if (agent.parameters["p9"].toLowerCase() == "nunca") {
        ...
        agent.parameters["p9"].toLowerCase() == "mais da metade dos dias"
      ) {
        rp9 = 2;
      } else if (
        agent.parameters["p9"].toLowerCase() == "quase todos os dias"
      ) {
        rp9 = 3;
      }
      ...
      if (dpResult >= 0 && dpResult <= 4) {
        agent.add(
          nameflag + " sua pontuação foi: " + dpResult + " - Sem depressão"
        );
